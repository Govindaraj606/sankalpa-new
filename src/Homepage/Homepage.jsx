                ...
                <div className='doctor-content' >
                    <div className='doctor-card'>
                        ...
                        <div className='doctor-deatils'>
                            ...
                            <Link to={'/doctor/dr-jagadish'}><button className="doctor-btn"><img className='dot-img' src={assets.dot} alt="skin whitening treatment in vijay nagar" />Know More</button></Link>
                        </div>
                    </div>
                    ...
                    <div className='doctor-card'>
                        ...
                        <div className='doctor-deatils'>
                            ...
                            <Link to={'/doctor/dr-sridutt'}><button className="doctor-btn"><img className='dot-img' src={assets.dot} alt="Sankalpa Clinic dermatology vijay nagar" />Know More</button></Link>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className='mobile-card'>
                        <div className='mobile-doctor-card' onClick={() => showCard(0)} style={{ height: isShow[0] ? "500px" : "280px" }} >
                            ...
                            <div className='mobile-doctor-deatils'>
                                ...
                                <Link to={'/doctor/dr-jagadish'}><button className="mobile-doctor-btn"><img className='dot-img' src={assets.dot} alt="hair loss treatment at Sankalpa Clinic" />Know More</button></Link>
                            </div>
                        </div>
                        ...
                        <div className='mobile-doctor-card' onClick={() => showCard(1)} style={{ height: isShow[1] ? "500px" : "280px" }}>
                            ...
                            <div className='mobile-doctor-deatils'>
                                ...
                                <Link to={'/doctor/dr-sridutt'}><button className="mobile-doctor-btn"><img className='dot-img' src={assets.dot} alt="laser treatment for face Sankalpa Clinic" />Know More</button></Link>
                            </div>
                        </div>
                    </div>
                </div>
